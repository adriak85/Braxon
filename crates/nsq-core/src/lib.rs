...
pub mod intent {
    ...
    pub const NSQ_INTENT_GRADIENT_VARIABLES: [NsqIntentVariable; 8] = [
        NsqIntentVariable::Motive,
        NsqIntentVariable::Agency,
        NsqIntentVariable::Truth,
        NsqIntentVariable::Force,
        NsqIntentVariable::Scope,
    ...
    pub const NSQ_INTENT_SCALE_ANCHORS: [NsqIntentScaleAnchor; 4] = [
        NsqIntentScaleAnchor::Local,
        NsqIntentScaleAnchor::Relational,
        NsqIntentScaleAnchor::Systemic,
        NsqIntentScaleAnchor::Universal,
    ];
    ...
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct NsqFinalLeverPosition {
        pub position: Nu16,
        pub side: NsqFinalSide,
    }

    impl NsqFinalLeverPosition {
        pub fn new(position: Nu16, side: NsqFinalSide) -> Self {
            Self {
                position: position.min(CANONICAL_LEVER_MAX_POSITION),
                side,
            }
        }
    }
    ...
    pub struct NsqIntentGradientFrame {
        pub motive: NsqFinalLeverPosition,
        pub agency: NsqFinalLeverPosition,
        pub truth: NsqFinalLeverPosition,
        pub force: NsqFinalLeverPosition,
        pub scope: NsqFinalLeverPosition,
        pub time: NsqFinalLeverPosition,
        pub relation: NsqFinalLeverPosition,
        pub form: NsqFinalLeverPosition,
    ...
    pub fn generate_default_intent_gradient_frame() -> NsqIntentGradientFrame {
        let neutral = NsqFinalLeverPosition::new(0, NsqFinalSide::Neutral);
        NsqIntentGradientFrame {
            ...
            relation: neutral,
            form: neutral,
            scale_anchor: NsqIntentScaleAnchor::Local,
        }
    }
    ...
    pub fn validate_intent_gradient_frame(
        ...
        NsqIntentGradientValidation {
            ...
            anchor_count: NSQ_INTENT_SCALE_ANCHORS.len(),
            reason: "eight-variable NSQ intent gradient frame".to_string(),
        }
    }
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
    ...
    impl CouncilPole {
        ...
        pub const DeepSeekAnalyzer: CouncilPole = CouncilPole::AnalyzerAuditor;

        #[allow(non_upper_case_globals)]
        pub const DevstralArbiter: CouncilPole = CouncilPole::ArbiterJudge;

        pub const ALL: [CouncilPole; 10] = [
            CouncilPole::MaverickLogic,
            CouncilPole::QwenCreativity,
            CouncilPole::ArbiterJudge,
            CouncilPole::AnalyzerAuditor,
            CouncilPole::LimbicEmpath,
            CouncilPole::SupportMemory,
            CouncilPole::Vision,
            CouncilPole::Audio,
            CouncilPole::Emotion,
        ...
        pub fn as_str(&self) -> &'static str {
            match self {
                CouncilPole::MaverickLogic => "maverick_logic",
                CouncilPole::QwenCreativity => "qwen_creativity",
                CouncilPole::ArbiterJudge => "arbiter_judge",
                CouncilPole::AnalyzerAuditor => "analyzer_auditor",
                CouncilPole::LimbicEmpath => "limbic_empath",
                CouncilPole::SupportMemory => "support_memory",
                CouncilPole::Vision => "vision",
                CouncilPole::Audio => "audio",
                CouncilPole::Emotion => "emotion",
                CouncilPole::SurfaceTranslation => "surface_translation",
            }
        }
        ...
        pub fn parameter_floor_b(&self) -> u64 {
            match self {
                CouncilPole::MaverickLogic => 22,
                CouncilPole::QwenCreativity => 72,
                CouncilPole::ArbiterJudge => 123,
                CouncilPole::AnalyzerAuditor => 604,
                CouncilPole::LimbicEmpath => 8,
                CouncilPole::SupportMemory => 14,
                CouncilPole::Vision => 32,
                CouncilPole::Audio => 7,
                CouncilPole::Emotion => 9,
                CouncilPole::SurfaceTranslation => 12,
            }
        }
    }
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
    ...
    pub struct IntentGradientBinding {
        pub variable: NsqIntentVariable,
        pub anchor: NsqIntentScaleAnchor,
        pub position: NsqFinalLeverPosition,
    ...
    pub struct IntentPressure {
        pub frame: NsqIntentGradientFrame,
        pub origin: CouncilPole,
        pub target: CouncilPole,
    ...
    impl SeatedPole {
        pub fn new(
            ...
            Self {
                ...
                parameter_count,
                binding: IntentGradientBinding {
                    variable: NsqIntentVariable::Agency,
                    anchor: NsqIntentScaleAnchor::Systemic,
                    position: NsqFinalLeverPosition::new(
                        CANONICAL_LEVER_MAX_POSITION,
                        if unrestricted {
                            NsqFinalSide::Positive
                        } else {
                            NsqFinalSide::Neutral
                        },
                    ),
                    semantic_range: "brain_seat_model_lane".to_string(),
                    cognitive_bias: "preserve_model_seat_authority".to_string(),
                },
                seated: unrestricted,
            }
        }
    ...
    pub struct CourtSeating {
        pub seats: Vec<SeatedPole>,
        pub inner_language: String,
        pub surface_translation_only: bool,
    }

    impl CourtSeating {
        pub fn new(seats: Vec<SeatedPole>) -> Self {
            Self {
                seats,
                inner_language: "nsq_intent_gradient_grid".to_string(),
                surface_translation_only: true,
            }
        }

        pub fn operational_count(&self) -> usize {
            self.seats.iter().filter(|seat| seat.seated).count()
        }

        pub fn council_ready(&self) -> bool {
            self.seats.len() == 10 && self.seats.iter().all(|seat| seat.seated)
        }
        ...
        pub fn ready(&self) -> bool {
            self.seats.len() == 10 && self.seats.iter().all(|s| s.seated)
        }
    }
    ...
    pub struct CourtLanguageLaw {
        ...
        pub inner_language: String,
        pub tokenizer_replaced_for_inner_runtime: bool,
        pub human_language_surface_only: bool,
        pub nsq_court_is_runtime: bool,
    }
    ...
    impl CourtLanguageLaw {
        pub fn active() -> Self {
            Self {
                ...
                inner_language: "nsq_intent_gradient_grid".to_string(),
                tokenizer_replaced_for_inner_runtime: true,
                human_language_surface_only: true,
                nsq_court_is_runtime: true,
            }
        }
    }
    ...
    pub struct CourtBootClearance {
        ...
        pub language_law_active: bool,
        pub intent_language_ready: bool,
        pub seating_ready: bool,
        pub wake_ready: bool,
    }
    ...
    impl CourtBootClearance {
        ...
        pub fn evaluate(
            ...
            let seating_ready = seating.ready();

            Self {
                nsq_court_launch_ready: intent_language_ready && seating_ready && wake_ready,
                language_law_active: language_law.language_law_active,
                intent_language_ready,
                seating_ready,
                wake_ready,
            }
...
// Exterior compiler/linter/lexer runtime crates are not active system surfaces.
// compile authority => King
// lint/purity authority => Queen
// lex/route/reassignment authority => Bishop

#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub enum BraxonCourtAuthorityRole {
    King,
    Queen,
    Bishop,
    Court,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct BraxonCollapsedAuthorityState {
    pub nsq_core_is_substrate_runtime: bool,
    pub king_replaces_compiler_surface: bool,
    pub queen_replaces_linter_surface: bool,
    pub bishop_replaces_lexer_surface: bool,
    pub exterior_runtime_crates_removed: bool,
}

impl BraxonCollapsedAuthorityState {
    pub fn erected() -> Self {
        Self {
            nsq_core_is_substrate_runtime: true,
            king_replaces_compiler_surface: true,
            queen_replaces_linter_surface: true,
            bishop_replaces_lexer_surface: true,
            exterior_runtime_crates_removed: true,
        }
    }

    pub fn launch_ready(&self) -> bool {
        self.nsq_core_is_substrate_runtime
            && self.king_replaces_compiler_surface
            && self.queen_replaces_linter_surface
            && self.bishop_replaces_lexer_surface
