...
pub const WOWAS_COHESIVE_CANON_V1: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/canon/wowas_canon_v1.md"
);
...
pub const WOWAS_CANON_LAWS: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
...
pub const WOWAS_CANONICAL_STORY_TREE: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
...
pub fn wowas_pack_root() -> &'static str { WOWAS_PACK_ROOT }
pub fn wowas_authority_file() -> &'static str { WOWAS_ACTIVE_CANON_CONTROL }
pub fn wowas_active_canon_control() -> &'static str { WOWAS_ACTIVE_CANON_CONTROL }
pub fn wowas_cohesive_canon_v1() -> &'static str { WOWAS_COHESIVE_CANON_V1 }
pub fn wowas_source_of_truth_registry_v14() -> &'static str { WOWAS_SOURCE_OF_TRUTH_REGISTRY_V14 }
pub fn wowas_authority_manifest_v13() -> &'static str { WOWAS_AUTHORITY_MANIFEST_V13 }
pub fn wowas_authority_router_v13() -> &'static str { WOWAS_AUTHORITY_ROUTER_V13 }
pub fn wowas_canonical_story_tree() -> &'static str { WOWAS_CANONICAL_STORY_TREE }
pub fn wowas_books_root() -> &'static str { WOWAS_BOOKS_ROOT }
pub fn wowas_book_01_root() -> &'static str { WOWAS_BOOK_01_ROOT }
pub fn wowas_scene_heading_index() -> &'static str { WOWAS_SCENE_HEADING_INDEX }
pub fn wowas_clean_scene_index() -> &'static str { WOWAS_CLEAN_SCENE_INDEX }
pub fn wowas_book_spine_33() -> &'static str { WOWAS_BOOK_SPINE_33 }
pub fn wowas_character_timeline_lattice_v14() -> &'static str { WOWAS_CHARACTER_TIMELINE_LATTICE_V14 }
pub fn wowas_canon_laws() -> &'static str { WOWAS_CANON_LAWS }
pub fn wowas_canon_blocklist() -> &'static str { WOWAS_CANON_BLOCKLIST }
pub fn wowas_character_generation_review_v14() -> &'static str { WOWAS_CHARACTER_GENERATION_REVIEW_V14 }

pub fn wowas_prose_and_tone_guide() -> &'static str {
    include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/canon/control/prose_and_tone_guide_v14.json"))
}
