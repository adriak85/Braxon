...
/* Define to 1 if you have the declaration of 'PR_SET_VMA_ANON_NAME', and to 0
   if you don't. */
#define HAVE_DECL_PR_SET_VMA_ANON_NAME 1
...
#define HAVE_EFFICIENT_BUILTIN_SHUFFLEVECTOR 1
...
/* Define to 1 if libgcc __register_frame and __deregister_frame are linkable.
   */
#define HAVE_LIBGCC_EH_FRAME_REGISTRATION 1
...
#define HAVE_LINUX_CAN_ISOTP_H 1
...
/* Define to 1 if 'stx_atomic_write_unit_min' is a member of 'struct statx'.
   */
#define HAVE_STRUCT_STATX_STX_ATOMIC_WRITE_UNIT_MIN 1
...
#define HAVE_STRUCT_STATX_STX_SUBVOL 1
...
#define _Py_WITH_FRAME_POINTERS 1
